...
class AlphabeticalComparatorTest {
	...
	public void testGetChildrenRoot() {
		...
		LinkedList<FSElement> actual = directory.getChildren(new AlphabeticalComparator());
	...
	public void testGetSubDirectoriesRoot() {
		Directory directory = root;
		LinkedList<Directory> actual = directory.getSubDirectories(new AlphabeticalComparator());
	...
	public void testGetFilesPictures() {
		...
		LinkedList<File> actual = directory.getFiles(new AlphabeticalComparator());
	...
	public void testGetLinksRoot() {
		Directory directory = root;
		LinkedList<Link> actual = directory.getLinks(new AlphabeticalComparator());
